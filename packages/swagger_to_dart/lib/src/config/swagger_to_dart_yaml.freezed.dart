    ...
    switch (_that) {
      case _ModelConfig() when $default != null:
        return $default(
            ...
            _that.disableEnumGeneration,
            _that.alwaysNullableTypes);
      case _:
        return orElse();
    }
  }
...
mixin _$ApiClientConfig {
  ...
  @override
  String toString() {
    return 'ApiClientConfig(baseApiClientClassName: $baseApiClientClassName, useClassForQueryParameters: $useClassForQueryParameters, useClassForMultipartFormData: $useClassForMultipartFormData, skippedParameters: $skippedParameters, allHeadersOptional: $allHeadersOptional)';
  }
}
